...
"""
Non-linear regressions are a relationship between independent variables  𝑥  and a dependent variable  𝑦  which 
result in a non-linear function modeled data. Essentially any relationship that is not linear can be termed as non-linear, 
...
We download a dataset with two columns, the first, a year between 1960 and 2014, the second, 
...
plt.plot(x_data, y_data, 'ro')
#the 'ro' determine the color and shape of the line, the "r" means the line is red and 'o' determine the shape
...
print("R_square: %.2f" %r2_score(y_hat, test_y))